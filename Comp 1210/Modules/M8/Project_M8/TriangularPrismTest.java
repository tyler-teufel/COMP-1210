...
public class TriangularPrismTest {
   ...
   @Test public void equalsTest() {
      ...
      TriangularPrism p13a = new TriangularPrism("P13", 27.0, 40.0); 
      TriangularPrism p13b = new TriangularPrism("P11", 28.0, 40.0); 
      TriangularPrism p13c = new TriangularPrism("P11", 27.0, 41.0); 
      int number0 = 17;

      Assert.assertEquals(true, p11.equals(p12)); 
      Assert.assertEquals(false, p11.equals(p13a));
      Assert.assertEquals(false, p11.equals(p13b));
      Assert.assertEquals(false, p11.equals(p13c));
      Assert.assertEquals(false, p11.equals(number0));
   ...
   @Test public void compareToTest1() {
      TriangularPrism num1 = new TriangularPrism("Small", 5, 10);
      TriangularPrism num2 = new TriangularPrism("Small", 5, 10);
      Assert.assertEquals(0, num1.compareTo(num2));
      
   }
   
   /** Test compareTo method. **/
   @Test public void compareToTest2() {
      TriangularPrism num1 = new TriangularPrism("Small", 6, 10);
      TriangularPrism num2 = new TriangularPrism("Small", 5, 10);
      Assert.assertEquals(1, num1.compareTo(num2));
   ...
   @Test public void compareToTest3() {
      TriangularPrism num1 = new TriangularPrism("Small", 5, 10);
      TriangularPrism num2 = new TriangularPrism("Small", 6, 10);
      Assert.assertEquals(-1, num1.compareTo(num2));
