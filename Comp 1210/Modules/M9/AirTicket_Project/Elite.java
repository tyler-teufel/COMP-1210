...
public class Elite extends Business {
   ...
   public Elite(String flightNumberIn, Itinerary tripDataIn,
    ...
    public Elite(String flightNum, Itinerary plan, double baseFareIn, double fareAdjustmentFactorIn, double foodAndBevIn, double entertainmentIn, double commServIn) {
    }

   public Elite(String flightNum, Itinerary plan, double parseDouble, double parseDouble1, double parseDouble2, double parseDouble3, double parseDouble4) {
      super();
   }
