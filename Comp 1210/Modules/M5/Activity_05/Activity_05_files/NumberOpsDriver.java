...
public class NumberOpsDriver {
   ...
   public static void main(String[] args) {
      ...
      NumberOperations numsEntered = new NumberOperations(in.nextInt());
      ...
      while (numsEntered.getValue() != 0) {
         numOpsList.add(numsEntered);
         numsEntered = new NumberOperations(in.nextInt());
      }
      int index = 0;
